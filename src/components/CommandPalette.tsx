...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const commands: CommandItem[] = [
    ...
    { id: 'export-office', title: 'Ofis Formatlarına Dışa Aktar (Word, Excel, PPT, Markdown)', category: 'İşlemler', icon: <FileSpreadsheet size={15} color="#3b82f6" />, action: onOpenExportOfficeModal },
